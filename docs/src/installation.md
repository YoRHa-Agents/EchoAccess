...
|----------|-------------|----------|
| Linux | x86_64 | `echoax-v0.1.1-x86_64-unknown-linux-gnu.tar.gz` |
| Linux | aarch64 | `echoax-v0.1.1-aarch64-unknown-linux-gnu.tar.gz` |
| macOS | Intel | `echoax-v0.1.1-x86_64-apple-darwin.tar.gz` |
| macOS | Apple Silicon | `echoax-v0.1.1-aarch64-apple-darwin.tar.gz` |
