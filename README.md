...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.3-C3BDA8?style=flat-square" alt="Version">
...
```bash
# Linux x86_64
curl -fsSL https://github.com/YoRHa-Agents/EchoAccess/releases/latest/download/echoax-v0.1.3-x86_64-unknown-linux-gnu.tar.gz | tar xz

# macOS Apple Silicon
curl -fsSL https://github.com/YoRHa-Agents/EchoAccess/releases/latest/download/echoax-v0.1.3-aarch64-apple-darwin.tar.gz | tar xz
```
...
Produces `dist/echoax-v0.1.3-{target}.tar.gz` for each platform.
